...
public class burgerpiza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_burgerpiza);

        recyclerView = findViewById(R.id.recyclerView);
        searchView = findViewById(R.id.search);
        searchView.clearFocus();

        GridLayoutManager gridLayoutManager = new GridLayoutManager(burgerpiza.this, 1);
        recyclerView.setLayoutManager(gridLayoutManager);

        AlertDialog.Builder builder = new AlertDialog.Builder(burgerpiza.this);
        ...
        adapter = new MyAdapter(burgerpiza.this, dataList);
        recyclerView.setAdapter(adapter);

        // Adjusting the reference to point to "localfoods" node under "foods"
        databaseReference = FirebaseDatabase.getInstance().getReference("foods").child("intfoods");
