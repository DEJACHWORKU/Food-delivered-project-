...
public class addnewdrink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addnewdrink);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference.child("drinks").child(key).setValue(localFoodItem);

                Toast.makeText(addnewdrink.this, "Your drink added successfully!", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(addnewdrink.this, hoteladmin.class);
