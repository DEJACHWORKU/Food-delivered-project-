...
public class drinks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(drinks.this, 1);
        ...
        adapter = new MyAdapter(drinks.this, dataList);
        recyclerView.setAdapter(adapter);

        // Adjusting the reference to point to "localfoods" node under "foods"
        databaseReference = FirebaseDatabase.getInstance().getReference("foods").child("drinks");
