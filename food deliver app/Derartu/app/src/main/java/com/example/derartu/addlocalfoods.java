...
public class addlocalfoods extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addlocalfoods);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference.child("localfoods").child(key).setValue(localFoodItem);

                Toast.makeText(addlocalfoods.this, "Your food added successfully!", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(addlocalfoods.this, hoteladmin.class);
